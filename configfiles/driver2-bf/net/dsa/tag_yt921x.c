...
/* Compatibility: ETH_P_YT921X and DSA_TAG_PROTO_YT921X are not defined
 * in kernels where the YT921x driver hasn't been merged yet.
 */
#ifndef ETH_P_YT921X
 ...
 * not available in kernels up to 6.18 (and thus not in 6.6). Same semantics as tag_ksz.c.
 */
